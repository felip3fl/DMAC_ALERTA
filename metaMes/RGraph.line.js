    ...
    RGraph.Line = function (conf)
    {
        ...
        */
        ...
        this.properties =
        {
            ...
            'chart.background.grid':        0,
            'chart.background.grid.width':  0,
            'chart.background.grid.hsize':  25,
            'chart.background.grid.vsize':  25,
            'chart.background.grid.color':  'BLUE',
            ...
            'chart.title.yaxis.x':          10,
            'chart.title.yaxis.y':          10,
            'chart.title.xaxis.x':          10,
            'chart.title.xaxis.y':          10,
            'chart.title.x':                null,
            'chart.title.y':                null,
            ...
            'chart.key.text.color':         'white',
            'chart.contextmenu':            null,
            'chart.ylabels':                true,
            'chart.ylabels.count':          5,
            'chart.ylabels.inside':         false,
            'chart.ylabels.offsetx':        -5,
            'chart.ylabels.offsety':        0,
            'chart.scale.invert':           false,
            'chart.xlabels.inside':         false,
            'chart.xlabels.inside.color':   'rgba(0,0,0,0)',
            'chart.noaxes':                 false,
            'chart.noyaxis':                false,
            'chart.noxaxis':                false,
            ...
            'chart.crosshairs.color':       'white',
            'chart.crosshairs.hline':       true,
            'chart.crosshairs.vline':       true,
            'chart.annotatable':            false,
            'chart.annotate.color':         'white',
