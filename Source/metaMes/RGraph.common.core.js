...
(function (win, doc, undefined)
{
    ...
    */
    ...
    RG.DrawTitle = function (obj, text, gutterTop)
    {
        ...
        co.beginPath();
        co.fillStyle = prop['chart.text.color'] ? prop['chart.text.color'] : 'white';
        ...
        */
        ...
        if (typeof prop['chart.title.color'] !== null) {
            ...
            co.fillStyle = newColor ? newColor : 'white';
        }
                ...
                if (labels_processed[i]) {
                    ...
                    if (coords && coords.length > 0) {
                        ...
                        co.beginPath();
                            ...
                            // Fore ground color
                            co.fillStyle = (typeof labels_processed[i] === 'object' && typeof labels_processed[i][1] === 'string') ? labels_processed[i][1] : 'white';
    ...
    RG.Text2 = function (obj, opt)
    {
        ...
        */
        ...
        var bounding                = opt.bounding,
            bounding_stroke         = opt['bounding.stroke'] ? opt['bounding.stroke'] : 'white',
